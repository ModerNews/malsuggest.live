class MyList():
    ...
    def get_user_anime_list(self, username="@me", sort=None, status=None, limit=100, optional_fields=None):
        ...
        if sort not in sort_options:
            sort = "list_score"
        params = {"sort": sort, "limit": limit, "fields": ",".join(["list_status"] + optional_fields)}
